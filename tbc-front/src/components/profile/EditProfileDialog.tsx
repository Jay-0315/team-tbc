      ...
      <div className="p-6 w-full max-w-xl bg-white rounded-2xl border border-gray-200 shadow-xl dark:border-gray-800 dark:bg-gray-900">
        ...
        <div className="mt-4 space-y-4">
          ...
          <div>
            ...
            <input value={displayName} onChange={(e) => setDisplayName(e.target.value)} className="p-2 w-full rounded-lg border border-gray-300 dark:border-gray-700 dark:bg-gray-800" placeholder="이름" />
          </div>
          <div>
        ...
        <div className="flex gap-2 justify-end mt-6">
          ...
          <Button onClick={onSubmit} disabled={isPending} aria-label="저장">
            {isPending ? '저장 중...' : '저장'}
          </Button>
        </div>
      </div>
